 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |  F1  |  F2  |  F3  |  F4  |      | GAME |           |      |BRBAK | CTAB |CSTAB |BRFWD |VOLUP | AS_UP  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |  F5  |  F6  |  F7  |  F8  |      |------|           |------| LEFT | DOWN |  UP  |RIGHT |VOLDN | AS_DN  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |  F9  |  F10 |  F11 |  F12 |      |      |           |      | PREV | STOP | PLAY | NEXT |      | AS_RP  |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |       |     |      |                                       |      |      |      |      | AS_T |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[FUNCL] = LAYOUT_ergodox_pretty(
    ...
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______, TG(GAME), /*****/ _______, KC_WBAK, CTRLTAB, CSFTTAB, KC_WFWD,  KC_VOLU, KC_ASUP,
    _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______, /**/      /*****/ /**/     KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_VOLD, KC_ASDN,
    _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______,  /*****/ _______, KC_MPRV, KC_MSTP, KC_MPLY, KC_MNXT,  _______, KC_ASRP,
