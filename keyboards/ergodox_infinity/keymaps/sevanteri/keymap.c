...
[BASE] = LAYOUT_ergodox_pretty(
    ...
    SH_MON,   KC_EQL, KC_GRV, KC_BTN2, KC_BTN1, /**/     /**/       /*****/ KC_RALT,   KC_PSCR, KC_INS, KC_RGUI,  SH_MON,
 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |      | PLAY |      |VOLUP |      | GAME |           |      |BRBAK | CTAB |CSTAB |BRFWD |VOLUP | AS_UP  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        | PREV | STOP | NEXT |VOLDN |      |------|           |------| LEFT | DOWN |  UP  |RIGHT |VOLDN | AS_DN  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |      |      |      |      |      |           |      | PREV | STOP | PLAY | NEXT |      | AS_RP  |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |       |     |      |                                       |      |      |      |      | AS_T |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[FUNCL] = LAYOUT_ergodox_pretty(
    ...
    _______, _______, _______, _______, _______, _______, TG(GAME), /*****/ _______, KC_WBAK, CTRLTAB, CSFTTAB, KC_WFWD,  KC_VOLU, KC_ASUP,
    _______, _______, _______, _______, _______, _______, /**/      /*****/ /**/     KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_VOLD, KC_ASDN,
    _______, _______, _______, _______, _______, _______, _______,  /*****/ _______, KC_MPRV, KC_MSTP, KC_MPLY, KC_MNXT,  _______, KC_ASRP,
...
[SYMB] = LAYOUT_ergodox_pretty(
    ...
    RALT(KC_GRV), _______,    RALT(KC_2), RALT(KC_3), RALT(KC_4), RALT(KC_5), _______, /*****/ _______, RALT(KC_6), RALT(KC_7), RALT(KC_8), RALT(KC_9), RALT(KC_0), RALT(KC_MINS),
