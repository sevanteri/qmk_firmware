...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
    ...
    ESCCTRL,  KC_A,    KC_S,   KC_D,    KC_F, KC_G,
    KC_LSFT,  KC_Z,    KC_X,   KC_C,    KC_V, KC_B, KC_DELT,
    KC_LCTRL, KC_EQL, KC_GRV, KC_BTN2, KC_BTN1,
...
[FUNCL] = LAYOUT_ergodox(  // layer 1 : functions
    ...
    _______, _______, KC_MPLY, _______, KC_VOLU, _______, TG(GAME),
    _______, KC_MPRV, KC_MSTP, KC_MNXT, KC_VOLD, _______,
    _______, _______, _______, _______, _______, _______, TG(BASE),
    ...
    _______, KC_WBAK, CTRLTAB, CSFTTAB, KC_WFWD,  _______, KC_ASUP,
    /**/     KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, _______, KC_ASDN,
    _______, _______, _______, _______, _______,  _______, KC_ASRP,
...
[GAME] = LAYOUT_ergodox(  // layer 3 : games
